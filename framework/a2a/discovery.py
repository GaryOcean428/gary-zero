...
class DiscoveryRequest(BaseModel):
    ...
    capabilities_filter: list[str] | None = Field(description="Filter by capabilities", default=None)
    protocols_filter: list[str] | None = Field(description="Filter by protocols", default=None)


class DiscoveryResponse(BaseModel):
    """A2A discovery response model"""
    success: bool = Field(description="Whether discovery was successful")
    agent_card: AgentCard | None = Field(description="Agent card information", default=None)
    filtered_capabilities: list[str] | None = Field(description="Filtered capabilities", default=None)
    available_services: list[str] | None = Field(description="Available services", default=None)
    error: str | None = Field(description="Error message if discovery failed", default=None)
