...
class OpenAICodexCLI(Tool):
    ...
    async def _handle_edit_action(self):
        ...
        try:
            ...
            if approval_mode == "suggest":
                ...
                if not approval:
                    return Response(
                        message="❌ Edit action cancelled by user.",
                        break_loop=False
                    )
            ...
            if result["success"]:
                ...
                return Response(
                    message=f"❌ Edit failed: {result['error']}",
                    break_loop=False
                )
    ...
    async def _handle_create_action(self):
        ...
        try:
            ...
            if approval_mode == "suggest":
                ...
                if not approval:
                    return Response(
                        message="❌ Create action cancelled by user.",
                        break_loop=False
                    )
            ...
            if result["success"]:
                ...
                return Response(
                    message=f"❌ Create failed: {result['error']}",
                    break_loop=False
                )

        except Exception as e:
            return Response(
                message=f"❌ Error during create: {str(e)}",
                break_loop=False
            )
    ...
    async def _handle_shell_action(self):
        ...
        try:
            ...
            return Response(
                message=f"❌ Error during shell execution: {str(e)}",
                break_loop=False
            )
