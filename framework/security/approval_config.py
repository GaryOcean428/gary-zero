...
class ApprovalConfigManager:
    ...
    def apply_config(self, config: dict[str, Any] | None = None) -> bool:
...
_config_manager: ApprovalConfigManager | None = None


def get_config_manager(config_file: str | None = None) -> ApprovalConfigManager:
