...
_global_workflow: ApprovalWorkflow | None = None
...
def get_global_approval_workflow() -> ApprovalWorkflow | None:
...
def _extract_user_id(
    extract_func: Callable | None, args: tuple, kwargs: dict
) -> str | None:
...
def approval_context(user_id: str, workflow: ApprovalWorkflow | None = None):
    """
...
class ApprovalContext:
    ...
    def __init__(self, user_id: str, workflow: ApprovalWorkflow | None = None):
...
async def request_batch_approval(
    user_id: str, actions: list[dict], workflow: ApprovalWorkflow | None = None
) -> dict[str, bool]:
    """
...
def _endpoint_requires_approval(path: str) -> bool:
    ...
    high_risk_patterns = ["/admin/", "/execute/", "/delete/", "/upload/", "/system/"]
