...
from framework.helpers.ai_action_interceptor import AIAction, AIActionType, AIProvider
...
class ActionStreamMessage:
    ...
    def __init__(self, message_type: str, data: Any = None, timestamp: Optional[datetime] = None):
    ...
    async def handle_client_message(self, client_id: str, message: str):
        ...
        try:
            ...
            if message_type == "subscribe":
                ...
                # Handle ping
                response = ActionStreamMessage("pong", {"timestamp": datetime.now(timezone.utc).isoformat()})
                await client.send_message(response)
