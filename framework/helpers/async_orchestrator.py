...
from framework.helpers.task_manager import TaskManager, TaskStatus
from framework.performance.async_utils import BackgroundTaskManager
...
class AsyncTaskOrchestrator:
    ...
    async def _start_task_execution(self, orchestration_task: OrchestrationTask):
        ...
        async with self.task_lock:
            ...
            orchestration_task.start_time = datetime.now(UTC)
    ...
    async def _handle_task_success(
        ...
        async with self.task_lock:
            ...
            orchestration_task.completion_time = datetime.now(UTC)
