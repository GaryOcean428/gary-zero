...
# Gary-Zero imports
from framework.helpers.task_manager import Task, TaskManager
...
class GaryZeroSDKAgent:
    ...
    def _start_trace(self, task_id: str, message: str) -> Trace:
        ...
        if trace:
            ...
            trace.add_tag("execution_time", datetime.now(UTC).isoformat())
        return trace
...
_orchestrator: SDKAgentOrchestrator | None = None
