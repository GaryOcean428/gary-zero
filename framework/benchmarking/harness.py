...
class TestExecutor(ABC):
    ...
    @abstractmethod
    async def execute(self, test_case: TestCase, config: dict[str, Any]) -> BenchmarkResult:
...
class BenchmarkHarness:
    ...
    async def run_single_test(self,
                             ...
                             executor_name: str,
                             config_name: str,
                             run_id: str | None = None) -> BenchmarkResult:
        ...
        # Log test start
        if self.logger:
            await self.logger.log_event(LogEvent(
    ...
    async def run_test_suite(self,
                           ...
                           max_concurrent: int = 5) -> list[BenchmarkResult]:
            ...
            for i, result in enumerate(results):
                if isinstance(result, Exception):
                    ...
                    failed_result = BenchmarkResult(
                        ...
                        configuration={"executor": executor_name, "config": config_name}
                    )
    ...
    async def load_results(self,
                          ...
                          task_ids: list[str] | None = None,
                          config_names: list[str] | None = None) -> list[BenchmarkResult]:
        ...
        for result_file in self.results_dir.glob("*.json"):
            try:
                ...
                if config_names and data.get('configuration', {}).get('config_name') not in config_names:
                    continue
