...
def test_legal_pages_exist():
    ...
    assert "data" in privacy_content.lower(), "Privacy policy missing data handling info"
...
def test_security_headers():
    ...
    assert "X-Content-Type-Options" in run_ui_content, "X-Content-Type-Options header missing"
