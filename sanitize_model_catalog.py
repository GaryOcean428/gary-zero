...
def load_allowed_models(file_path: str = "allowed_models.json") -> List[str]:
    ...
    try:
        ...
        print(f"Warning: {file_path} not found. Proceeding without allow-list filtering.")
        return []
...
def sanitize_provider_models(provider_models: List[Dict[str, Any]], 
                           allowed_models: List[str] = None) -> List[Dict[str, Any]]:
    ...
    if allowed_models:
        filtered_models = [
            model for model in deduplicated_models 
...
def sanitize_model_catalog(catalog: Dict[str, List[Dict[str, Any]]], 
                          allowed_models: List[str] = None) -> Dict[str, List[Dict[str, Any]]]:
