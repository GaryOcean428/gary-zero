...
from framework.logging.hooks import log_tool_execution, log_code_execution, log_operation
from framework.benchmarking.harness import BenchmarkHarness, TestExecutor, BenchmarkResult, TaskStatus
...
async def demonstrate_integration():
    ...
    print(f"   - Logs: ./logs/")
    print(f"   - Benchmark results: ./logs/benchmark_results/")
    print(f"   - Reports: ./logs/reports/")
