...
import models
from zero.helpers.settings.constants import MODEL_PARAMS_DESCRIPTION, PASSWORD_PLACEHOLDER
from zero.helpers.settings.field_builders import FieldBuilder
from zero.helpers.settings.types import Settings, SettingsField, SettingsSection
...
class SectionBuilder:
    ...
    def build_auth_section(settings: Settings) -> SettingsSection:
        ...
        from zero.helpers import (
            dotenv,  # Local import
            runtime,  # Local import
        )
        # from zero.helpers.settings.constants import PASSWORD_PLACEHOLDER # Already imported at top
    ...
    def build_agent_config_section(settings: Settings) -> SettingsSection:
        ...
        from zero.helpers import files  # Local import
