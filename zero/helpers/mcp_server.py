...
class ToolResponse(BaseModel):
    ...
    response: str = Field(description="The response from the remote Gary-Zero Instance")
...
class ToolError(BaseModel):
    ...
    error: str = Field(description="The error message from the remote Gary-Zero Instance")
    chat_id: str = Field(description="The id of the chat this message belongs to.")
...
async def send_message(
    ...
    Field(description="The response from the remote Gary-Zero Instance", title="response"),
]:
