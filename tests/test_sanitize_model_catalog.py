...
class TestModelCatalog(unittest.TestCase):
    ...
    def test_no_duplicate_values_within_provider(self):
        ...
        sanitized_catalog = sanitize_model_catalog(
            self.original_catalog, self.allowed_models
        )
            ...
            for model in models:
                ...
                if release_date:
                    ...
                    self.assertLessEqual(
                        release_date,
                        today,
                        f"Future release date found: {release_date} in {provider}",
                    )
