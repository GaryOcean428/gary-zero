function extractDOM([selectorLabel = "", selectorName = "data-a0sel3ct0r", guidName = "data-a0gu1d"]) {
    let elementCounter = 0;
    const time = new Date().toISOString().slice(11, -1).replace(/[:.]/g, "");
    const ignoredTags = ["style", "script", "meta", "link", "svg", "noscript", "path"];
    ...
    function convertAttribute(tag, attr) {
        ...
        if (out.name == "src" && out.value.startsWith("data:")) out.value = "data...";
