...
from framework.session import SessionType, RemoteSessionManager
    ...
    async def run(self) -> Dict[str, Any]:
        ...
        try:
            ...
            results['steps'].append({
                ...
                'output': gemini_response.data if gemini_response.success else gemini_response.error
            })
            ...
            results['steps'].append({
                ...
                'output': claude_response.data if claude_response.success else claude_response.error
            })
            ...
            results['steps'].append({
                ...
                'output': test_response.data if test_response.success else test_response.error
            })
            ...
            results['steps'].append({
                ...
                'output': screenshot_response.data if screenshot_response.success else screenshot_response.error
            })
    ...
    async def run(self, target: str = "example.com") -> Dict[str, Any]:
        ...
        try:
            ...
            results['steps'].append({
                ...
                'output': audit_response.data if audit_response.success else audit_response.error
            })
            ...
            results['steps'].append({
                ...
                'output': report_response.data if report_response.success else report_response.error
            })
            ...
            if git_add_response.success:
                ...
                results['steps'].append({
                    ...
                    'output': git_commit_response.data if git_commit_response.success else git_commit_response.error
                })
            else:
                results['steps'].append({
                    'step': 3,
            ...
            results['success'] = all(step['success'] for step in results['steps'][:2])  # Main steps
    ...
    async def run(self) -> Dict[str, Any]:
        ...
        try:
            ...
            results['steps'].append({
                ...
                'output': workspace_response.data if workspace_response.success else workspace_response.error
            })
            ...
            results['steps'].append({
                ...
                'output': doc_response.data if doc_response.success else doc_response.error
            })
            ...
            results['steps'].append({
                ...
                'output': tools_response.data if tools_response.success else tools_response.error
            })
            ...
            results['steps'].append({
                ...
                'output': final_screenshot_response.data if final_screenshot_response.success else final_screenshot_response.error
            })
...
async def run_example_workflows():
    ...
    try:
        ...
        logger.info(f"Code Generation Workflow Results:")
        ...
        logger.info(f"Security Audit Workflow Results:")
        ...
        logger.info(f"Multi-Tool Showcase Workflow Results:")
        ...
        logger.info("="*60)
        logger.info(f"Code Generation: {'✅ SUCCESS' if code_results.get('success') else '❌ FAILED'}")
        logger.info(f"Security Audit: {'✅ SUCCESS' if audit_results.get('success') else '❌ FAILED'}")
        logger.info(f"Multi-Tool Showcase: {'✅ SUCCESS' if showcase_results.get('success') else '❌ FAILED'}")
