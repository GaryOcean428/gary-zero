...
class ModernAnthropicTool:
    ...
    def rotate_api_key(self, new_key: str):
        ...
        from framework.security import store_secret, SecretMetadata, SecretType, AccessLevel
...
def anthropic_chat_completion(prompt: str, model: str = "claude-3-sonnet", api_key: str = None) -> str:
    """
...
class MultiServiceTool:
    ...
    def __init__(self):
        ...
        print(f"🔧 Multi-service tool initialized with: {', '.join(services) if services else 'No services'}")
...
def demonstrate_tool_modernization():
    ...
    patterns = [
        ...
        ("SecretStoreIntegration", "Class-based integration", "✅ Recommended for components"),
        ("Decorator Pattern", "Function decorators", "✅ Great for individual functions"),
