    ...
    try:
        while True:
            ...
            if elapsed > CRITICAL_THRESHOLD and not critical_sent:
                logger.error(f"🚨 CRITICAL: Build near timeout! {elapsed_minutes:.1f} minutes elapsed")
