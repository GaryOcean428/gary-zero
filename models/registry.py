...
class ModelRegistry:
    ...
    def get_recommended_model(self, use_case: str, max_cost: float | None = None) -> ModelConfig | None:
...
def get_recommended_model(use_case: str, max_cost: float | None = None) -> ModelConfig | None:
    """Get the recommended model for a specific use case."""
